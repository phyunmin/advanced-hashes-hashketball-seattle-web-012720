...
def game_hash()
  {
    ...
    {   team_name:"Charlotte Hornets",
        ...
        players:[
          ...
          {player_name:"Ben Gordon", number:8, shoe:15, points:33, rebounds:3, assists:2, steals:3, blocks:1, slam_dunks:0},
...
def team_colors(teamname)
  ...
  game_hash.each do |key, value|
    value.each do|name_color_players, values|
      if(name_color_players == :colors)
        pp name_color_players[teamname]
